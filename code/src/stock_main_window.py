...
class stock_main_window(QtWidgets.QMainWindow,Ui_stock_ui_window,stock_window,add_good_window):
    def __init__(self):
        ...
        self.setupUi(self)
        self.graphicsView_2.setStyleSheet("border-image: url(C://Users//Ben//Desktop//xf//facial_emotion_recognition__EMOJIFIER-master//kucun.png);")
        ...
        rows3=self.select('select 商品名称 from 商品 ORDER BY 商品ID',['商品名称'])[0]
        print(rows3)
        ...
        self.stock_window.stock_btn.clicked.connect(lambda x: self.caigou(sql, StockAgentID)
        )
    ...
    def caigou(self,sql,StockAgentID):
        self.IDU(
            ...
            sql.format(
                ...
                StockAgentID,
                self.get_CurrentIndex(self.stock_window.comboBox),

                float(self.stock_window.lineEdit_2.text()),
                self.get_CurrentIndex(self.stock_window.comboBox_2),
                int(self.stock_window.lineEdit_4.text()),
                self.get_CurrentIndex(self.stock_window.comboBox_3)
            ))
    ...
    def draw(self,sql, sql_getColumns,filename):
        ...
        self.graphicsView.setStyleSheet("border-image: url(C:/Users/Ben/Desktop/xf/facial_emotion_recognition__EMOJIFIER-master/src/{});".format(filename))    # 修改
